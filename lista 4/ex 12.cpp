...
int main(){ 
	...
	porcentagem[0]=(votos_1/total_votos)*100;
	porcentagem[1]=(votos_2/total_votos)*100;
	porcentagem[2]=(votos_3/total_votos)*100;
	porcentagem[3]=(votos_4/total_votos)*100;
	porcentagem[4]=(votos_nulo/total_votos)*100;
	porcentagem[5]=(votos_branco/total_votos)*100;
	

	printf("o candidato 1 teve %i votos sendo %.2fl do total\n",votos_1,porcentagem[0]);
	printf("o candidato 2 teve %i votos sendo %.2fl do total\n",votos_2,porcentagem[1]);
	printf("o candidato 3 teve %i votos sendo %.2fl do total\n",votos_3,porcentagem[2]);
	printf("o candidato 4 teve %i votos sendo %.2fl do total\n",votos_4=0,porcentagem[3]);
	printf("%i votos foram nulos sendo %;2fl do total\n",votos_nulo,porcentagem[4]);
	printf("%i votos foram brancos sendo %.2fl do total\n",votos_branco,porcentagem[5]);
}
